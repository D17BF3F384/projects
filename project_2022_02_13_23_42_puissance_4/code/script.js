...
function isDataOkay(redPlayer, yellowPlayer) {
...
$(function() {
    ...
    $(".clear-dimensions").click(function() {
        sessionStorage.setItem("columns", "");
        sessionStorage.setItem("rows", "");
        $(".columns-input").val("");
        $(".rows-input").val("");
    });
    $(".clear-names").click(function() {
        sessionStorage.setItem("yellow-player", "");
        sessionStorage.setItem("red-player", "");
        $(".yellow-input").val("");
        $(".red-input").val("");
    ...
    $(".start-button").click(function() {
        ...
        if(isDataOkay(redPlayer, yellowPlayer) === true) {
            $(".menu-div").hide();
            $(".revenge-button").hide();
            $(".game-div").show();
            $(".undo-button").hide();
